        ...
        >
          <Link href={"/"}>
            {isOpen ? (
              ...
              <div className="w-8 h-8 bg-[#E44B37] rounded-lg flex items-center justify-center">
                    ...
                    {isOpen ? (
                      ...
                      <div className="relative group">
                        ...
                        <div className="absolute left-full ml-2 px-3 py-2 bg-white border border-gray-200 text-gray-700 text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50 min-w-max shadow-lg">
                          <div className="font-medium text-sm mb-2 text-[#E44B37]">
                            {item.label}
                          </div>
                          <div className="space-y-1">
                            {item.subItems.map((subItem, index) => (
                              <Link
                                key={index}
                                href={subItem.href}
                                className={`block px-2 py-1 text-xs text-gray-600 hover:text-white hover:bg-[#E44B37] rounded transition-colors ${
                                  isActive(subItem.href)
                                    ? "text-white bg-[#E44B37]"
                                    : ""
                                }`}
                              >
                                {subItem.label}
